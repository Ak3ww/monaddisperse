...
export default function DisperseUI() {
    ...
    const handleSend = async () => {
      ...
      try {
          ...
          // Start toast notification and await the transaction in one go
          ...
          console.error("Transaction Error:", error); // Log the full error
          toast.error(`Transaction failed: ${error.message}`, { // Show error message
              position: toast.POSITION.TOP_CENTER,
              autoClose: 5000,
          });
      } finally {

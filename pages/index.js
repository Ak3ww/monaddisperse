...
import { Web3Button, useWeb3Modal, useWeb3ModalAccount } from "@web3modal/react";
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto bg-white shadow-lg rounded-lg">
      ...
      <div className="mb-4 text-center">
        {!isConnected ? (
          <Button onClick={open} className="w-full py-2 text-lg font-semibold">Connect Wallet</Button>
        ) : (
          <Web3Button />
        )}
      </div>
      ...
      <Textarea 
        placeholder="Enter wallet addresses separated by space or comma, followed by the amount.\nExample:\n0x123...abc 10\n0x456...def 20"
        value={manualData} 
        onChange={handleManualInput} 
        className="mb-4 h-96 w-full resize-none border-gray-300 border rounded-lg p-4 text-sm"
      />
